...
COPY --from=frontend-build /app/src/petstore/static /app/src/petstore/static
...
ENV RELEASE=${RELEASE} \
    GIT_SHA=${COMMIT_HASH} \
    PYTHONUNBUFFERED=1 \
    DJANGO_SETTINGS_MODULE=petstore.conf.docker

ARG SECRET_KEY=dummy

LABEL org.label-schema.vcs-ref=$COMMIT_HASH \
      org.label-schema.vcs-url="https://bitbucket.org/maykinmedia/petstore" \
      org.label-schema.version=$RELEASE \
      org.label-schema.name="petstore"
