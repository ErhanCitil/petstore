...
DATABASES = {
    "default": {
        ...
        "NAME": config("DB_NAME", "petstore"),
        "USER": config("DB_USER", "petstore"),
        "PASSWORD": config("DB_PASSWORD", "petstore"),
...
TEMPLATES = [
    {
        ...
        "OPTIONS": {
            "context_processors": [
                ...
                "petstore.utils.context_processors.settings",
            ],
...
DEFAULT_FROM_EMAIL = "petstore@example.com"
...
LOGGING = {
    ...
    "handlers": {
        ...
        "project": {
            "level": "DEBUG",
            "class": "logging.handlers.RotatingFileHandler",
            "filename": LOGGING_DIR / "petstore.log",
            "formatter": "verbose",
            "maxBytes": 1024 * 1024 * 10,  # 10 MB
            "backupCount": 10,
        },
...
AUTHENTICATION_BACKENDS = [
    ...
    "petstore.accounts.backends.UserModelEmailBackend",
    "django.contrib.auth.backends.ModelBackend",
]

SESSION_COOKIE_NAME = "petstore_sessionid"
...
CSRF_FAILURE_VIEW = "petstore.accounts.views.csrf_failure"
...
ADMIN_INDEX_DISPLAY_DROP_DOWN_MENU_CONDITION_FUNCTION = (
    "petstore.utils.django_two_factor_auth.should_display_dropdown_menu"
)
...
ELASTIC_APM = {
    "SERVICE_NAME": f"petstore {ENVIRONMENT}",
